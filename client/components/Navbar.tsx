...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Sayfa 50 pikselden fazla kaydırıldığında arka planı opak yap
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-50 transition-colors duration-300 ${scrolled ? 'bg-[#000034]' : 'bg-transparent'}`}>
      <nav className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-[188px] py-4 lg:py-6">
